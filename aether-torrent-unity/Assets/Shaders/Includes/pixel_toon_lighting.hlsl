...
// EDITS BEGIN
void AdditionalLightsToonAttenuation_float(float3 WorldPosition, float3 WorldNormal, half4 Shadowmask, float PointLightBands, float SpotLightBands, out float3 Diffuse, out float Attenuation)
{
    float3 diffuseColor = 0;
    float attenSum = 0;

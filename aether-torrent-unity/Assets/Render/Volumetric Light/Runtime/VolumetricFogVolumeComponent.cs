...
[VolumeComponentMenuForRenderPipeline("Custom/Volumetric Fog", typeof(UniversalRenderPipeline))]
	...
	public sealed class VolumetricFogVolumeComponent : VolumeComponent, IPostProcessComponent
	{
		...
		[Header("Noise")]
		public TextureParameter volumeNoiseTexture = new TextureParameter(null);
		public Vector4Parameter noiseScale = new Vector4Parameter(Vector4.one);
		public Vector4Parameter noiseSpeed = new Vector4Parameter(Vector4.zero);
		public FloatParameter noiseHeightInfluence = new FloatParameter(0.5f);
		public FloatParameter noiseBlendFactor = new FloatParameter(0.5f);
